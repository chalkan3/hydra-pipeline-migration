...
-- Meta Class
SpaPaymentTermProd = { type="", stages = {}, variables = { enviroment = "", awsAcessKeyId = "", awsAcessKeyLogic = ""} , projectId = 0, targetBranch = "", 
...
-- Class
function SpaPaymentTermProd:new (type)
	local obj = {}
	...
	self.nameBranch = "feature/pipeline-devops-prod"
...
function SpaPaymentTermProd:migrate ()
