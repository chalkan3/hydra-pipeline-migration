...
-- Meta Class
SpaPaymentTermQa = { type="", stages = {}, variables = { enviroment = "", awsAcessKeyId = "", awsAcessKeyLogic = ""} , projectId = 0, targetBranch = "", 
...
-- Class
function SpaPaymentTermQa:new (type)
	local obj = {}
	...
	self.projectId = 10
	self.targetBranch = "qa"
	self.nameBranch = "feature/pipeline-devops-qa"
	self.commitMessage = "feature(pipeline): colocando develop"
...
function SpaPaymentTermQa:migrate ()
